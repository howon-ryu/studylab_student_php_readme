      ...
      <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
		...
		<!-- 2023.03.14 리포트 팝업 -->
		  <div id="popup_wrap">
			  ...
			  <div id="report_tab">
					<dd class="tab_off"><a>일간</a></dd>
					<dd class="tab_on">주간</dd>
					<dd class="tab_off"><a>월간</a></dd>
			  </div>			  
			  
			  <div id="report_contents">
				  <dr>
				  <dd class="report_left">
					  <h3 class="report_date">2023.03.13 ~ 2023.03.18</h3>
					  ...
					  <table id="report_hours" width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tbody>
							...
							<tr>
							  <td><div class="report_time">10:10:12</div></td>
							  <td><div class="report_time">103:30:43</div></td>
							  <td><div class="report_time puretime">71:55:12</div></td>
							</tr>
						  </tbody>
						</table>
					  <h3>순공효율(%)</h3>
					  ...
					  <div class="report_graph">
						  <a><img alt="순공효율(%)" src="/assets/media/images/grp_01.png"></a>                
					  </div>
				  </dd>
				  <dd>
					  <h3>과목별 학습 만족도</h3>
					  <!-- 그래프 이미지로 자리만 잡았어요. 비슷한 사이즈로 넣어주세요. -->
					  <div class="report_graph">
						  <a><img alt="과목별 학습 만족도" src="/assets/media/images/grp_02.png"></a>                
					  </div>
					  <h3>과목별 목표대비 순공(%)</h3>
					  <!-- 그래프 이미지로 자리만 잡았어요. 비슷한 사이즈로 넣어주세요. -->
					  <div class="report_graph">
						  <a><img alt="과목별 학습 만족도" src="/assets/media/images/grp_03.png"></a>                
					  </div>
				  </dd>
				  <dd>
					  <h3>과목별 순공 와플차트</h3>
					  <!-- 그래프 이미지로 자리만 잡았어요. 비슷한 사이즈로 넣어주세요. -->
					  <div class="report_graph">
						  <a><img alt="과목별 학습 만족도" src="/assets/media/images/grp_04.png"></a>                
					  </div>
					  <h3>주간 과목별 누적 순공 추</h3>
					  <!-- 그래프 이미지로 자리만 잡았어요. 비슷한 사이즈로 넣어주세요. -->
					  <div class="report_graph">
						  <a><img alt="과목별 학습 만족도" src="/assets/media/images/grp_05.png"></a>                
					  </div>					  
				  </dd>
				  </dr>
			  </div>
